...
This shows us the `entity,n-authors,n-revs`. But these results are not in the `logfile.log` file, and we can tell by printing the contents of `logfile.log` file to the Terminal.
